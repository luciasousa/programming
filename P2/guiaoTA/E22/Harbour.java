...
public class Harbour {
  ...
  private HashTable<Integer> destinations = new HashTable<>(11);
  ...
  public void enterContainer(int dockId,Container c) {
    ...
    //Updates the info about the destinations
	if(!destinations.contains(c.destination)){
		destinations.set(c.destination, 1);
	}
	else{
		destinations.set(c.destination, destinations.get(c.destination)+1);
	}
